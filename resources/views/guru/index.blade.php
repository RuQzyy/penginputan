    ...
    <div class="bg-white rounded shadow p-4">
     ...
     <div class="overflow-x-auto">
      <ul class="list-disc pl-5">
       <li class="mb-2">Pengumuman 1: Ujian Tengah Semester akan dilaksanakan pada tanggal 15 Maret 2023.</li>
       <li class="mb-2">Pengumuman 2: Libur sekolah dimulai dari tanggal 20 Desember 2023 hingga 5 Januari 2024.</li>
       <li class="mb-2">Pengumuman 3: Pendaftaran lomba matematika nasional dibuka hingga 30 April 2023.</li>
