 ...
 <body class="bg-gray-100">
  <div class="flex">
   ...
   <div class="w-64 bg-gray-900 text-white min-h-screen fixed">
    ...
    <div class="p-4 flex items-center">
     <img alt="User profile picture" class="rounded-full w-10 h-10" height="40" src="https://storage.googleapis.com/a1aa/image/3L0jd6R3WbPZFVs7bpnM5SXv5IFWv5vOgkzVWFg1IiI.jpg" width="40"/>
     <div class="ml-2">
      <div class="text-sm">
       Nama Admin
      </div>
    ...
    <div class="bg-white rounded shadow p-4">
     ...
     <div class="overflow-x-auto">
      <ul class="list-disc pl-5">
       <li class="mb-2">
        Pengumuman 1: Ujian Tengah Semester akan dilaksanakan pada tanggal 15 Maret 2023.
       </li>
       <li class="mb-2">
        Pengumuman 2: Libur sekolah dimulai dari tanggal 20 Desember 2023 hingga 5 Januari 2024.
       </li>
       <li class="mb-2">
        Pengumuman 3: Pendaftaran lomba matematika nasional dibuka hingga 30 April 2023.
       </li>
